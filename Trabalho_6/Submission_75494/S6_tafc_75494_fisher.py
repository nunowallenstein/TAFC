...
if doevaluate:
    ...
    for name in ["proctrain","proctest"]:
        ...
        for i in xrange(0, max_index):
            ...
            # compute bdt scoree    
            #maps['bdt'][0]=reader.EvaluateMVA("BDT method")
...
if dothreshold:
    ...
    hsigint=TH1F("hsigint","integrated signal vs fisher score",nbins,scoremin,scoremax)
    hbkgint=TH1F("hbkgint","integrated bkg vs bisher score",nbins,scoremin,scoremax)        
    hamsfinal=TH1F("hamsfinal","final ams vs fisher score",nbins,scoremin,scoremax)
    hamsasimov=TH1F("hamsasimov","asimov ams vs fisher score",nbins,scoremin,scoremax)
    hamssimple=TH1F("hamssimple","simple ams vs fisher score",nbins,scoremin,scoremax)
...
if dosubmission:
    ...
    print  "Loop once to load the EventId, fisher score pairs"
    max_index = inputtree.GetEntries()
    allentries=[]
    for i in xrange(0, max_index):
        if i % 100000==1:
